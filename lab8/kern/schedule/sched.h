...
/* switch global scheduling class to stride scheduler and migrate
 * existing runnable processes into stride run pool. */
void sched_set_class_stride(void);

/* update a runnable process's position in the current run-queue
 * (used when its scheduling parameters like priority change) */
